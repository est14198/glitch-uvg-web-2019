      ...
      <div style={divStyle}>
        <form style={formStyle}>
          ...
          {input !== ''
            ? (
              <div style={divS}>
                <button type="button" aria-label="X" value="X" className="fa fa-times" style={input2Style} onClick={this.clearText} tabIndex="0" />
                <button type="button" aria-label=" " className="fa fa-search" style={inputSearch} onClick={this.search} tabIndex="0" />
              </div>
            )
            : <button type="button" aria-label="Search" className="fa fa-search hover" tabIndex="0" />}
        </form>
      </div>
    );
  }
